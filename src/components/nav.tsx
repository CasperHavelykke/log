  ...
  return (
    <header className="sticky top-0 z-10 border-b border-border bg-background/80 backdrop-blur">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center gap-2 px-3 py-2 sm:gap-3 sm:px-4 sm:py-3">
        <Link
          href="/"
          className="inline-flex min-h-[44px] touch-manipulation items-center rounded-md px-2 py-1 active:bg-border/60 sm:min-h-0"
          aria-label="Forside"
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/logo-mark.svg" alt="Log" className="h-7 w-auto" />
        </Link>
