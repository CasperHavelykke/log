  ...
  return (
    <TodayPage
      ...
      initialDay={{
        ...
        headache: entry?.headache ?? false,
        headacheIntensity: entry?.headacheIntensity ?? null,
        iskiasPain: entry?.iskiasPain ?? null,
        alcoholUnits: entry?.alcoholUnits ?? null,
        constipation: entry?.constipation ?? false,
        constipationPain: entry?.constipationPain ?? null,
        seborrheicDermatitis: entry?.seborrheicDermatitis ?? null,
        staph: entry?.staph ?? null,
        ...
        breathingDifficulty: entry?.breathingDifficulty ?? null,
        breathingContext: entry?.breathingContext ?? "",
        foamyUrine: entry?.foamyUrine ?? false,
        foamyUrinePattern:
          (entry?.foamyUrinePattern as "morning" | "all_day" | null) ?? null,
